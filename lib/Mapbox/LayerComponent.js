...
export default class LayerComponent extends React.Component {
    ...
    update(source, map, style, updateStyle) {
        const { index: indexProp = null, interactive, minZoom, maxZoom } = this.props
        const { id } = this.state
    ...
    render() {
        ...
        return (
            <SourceContext.Consumer>
                {({ source, map, style, updateStyle }) => {
                    if (map) {
                        this.update(source, map, style, updateStyle)
                    }
                    return children
                }}
            </SourceContext.Consumer>
